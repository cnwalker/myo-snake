$(document).ready(function(){
    ...
    $.ajax({
       ...
       success: function (res) {
           ...
           {
               $('#canvas').width = res['canvasWidth']*cw;
               $('#canvas').height = res['canvasHeight']*cw;
           }
           ...
           function init()
        	...
        	function create_snake()
        	{
        		...
        		{
                    good_point = res['good_points'][Math.floor(Math.random()*res['good_points'].length)];
        	...
        	{
                console.log(Math.floor(Math.random()*res['good_points'].length));
                console.log('Memes', res['good_points']);

                var good_point = res['good_points'][Math.floor(Math.random()*res['good_points'].length)];
        		food = {
        			x: good_point[1],
        			y: good_point[0],
        		};
        	...
        	function paint()
        	{
                ...
                paint_board_with_image(res['good_points'], res['bad_points']);
